...
export default function Hero({ onExploreClick }) {
  return (
    <section className="relative w-full overflow-hidden py-16 sm:py-24 lg:py-32 my-6 rounded-3xl glass-panel border border-slate-800 shadow-2xl">
      <div 
        className="absolute inset-0 z-0 bg-cover bg-center opacity-25 scale-105 filter blur-xs"
        style={{
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center">
        <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/30 text-indigo-400 text-xs sm:text-sm font-medium mb-6">
